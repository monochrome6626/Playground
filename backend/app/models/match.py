...
class Match(Base):
    ...
    body_azimuth_deg: Mapped[float] = mapped_column(Float, nullable=False)
    body_altitude_deg: Mapped[float] = mapped_column(Float, nullable=False)
    landmark_azimuth_deg: Mapped[float] = mapped_column(Float, nullable=False)
    landmark_altitude_deg: Mapped[float] = mapped_column(Float, nullable=False)
    ...
    weather_summary: Mapped[str | None] = mapped_column(String(50))
