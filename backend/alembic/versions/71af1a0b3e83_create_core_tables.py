...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("body_azimuth_deg", sa.Float(), nullable=False),
        sa.Column("body_altitude_deg", sa.Float(), nullable=False),
        sa.Column("landmark_azimuth_deg", sa.Float(), nullable=False),
        sa.Column("landmark_altitude_deg", sa.Float(), nullable=False),
        sa.Column("azimuth_diff_deg", sa.Float(), nullable=False),
        sa.Column("altitude_diff_deg", sa.Float(), nullable=False),
        sa.Column("score", sa.Float(), nullable=False),
        sa.Column("weather_summary", sa.String(length=50), nullable=True),
        sa.ForeignKeyConstraint(["landmark_id"], ["landmarks.id"]),
